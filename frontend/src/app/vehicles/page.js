...
//                         <div
//                           key={vehicle.id}
//                           className={`bg-white border-2 shadow-md px-2 pb-4 pt-2 rounded-lg overflow-hidden flex flex-col ${favorites.includes(vehicle.id) ? "border-red-500" : ""
//                             }`}
//                         >
...
//                                 className={`w-8 h-8 ${favorites.some((favorite) => favorite.id === vehicle.id)
//                                     ? "text-red-600"
//                                     : "text-gray-500"
...
//                         disabled={page === 1}
//                         className={`mr-2 px-4 py-2 rounded-l-md ${page > 1
//                             ? "bg-primary text-white"
//                             : "bg-gray-300 text-gray-500 cursor-not-allowed"
//                           }`}
//                       >
...
//                         onClick={() => handlePageChange(page - 1)}
//                         disabled={page === 1}
//                         className={`mr-2 px-4 py-2 ${page > 1
//                             ? "bg-primary text-white"
//                             : "bg-gray-300 text-gray-500 cursor-not-allowed"
//                           }`}
//                       >
...
//                         onClick={() => handlePageChange(page + 1)}
//                         disabled={page === pagination.totalPages}
//                         className={`ml-2 px-4 py-2 ${page < pagination.totalPages
//                             ? "bg-primary text-white"
//                             : "bg-gray-300 text-gray-500 cursor-not-allowed"
//                           }`}
//                       >
...
//                         disabled={page === pagination.totalPages}
//                         className={`ml-2 px-4 py-2 rounded-r-md ${page < pagination.totalPages
//                             ? "bg-primary text-white"
//                             : "bg-gray-300 text-gray-500 cursor-not-allowed"
//                           }`}
//                       >
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-2 py-6">
      ...
      {modal2Open && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg w-1/3">
            <h2 className="text-lg font-bold text-center">Buy Equipment</h2>
            <h2 className="text-lg font-semibold text-gray-500 text-center">{selectedVehicle2.name}</h2>
            <h2 className="text-sm text-gray-500 text-center font-bold mb-4">
              Provide us your email, we will contact you soon.
            </h2>
            <input
              type="email"
              value={email2}
        ...
        <>
          {!selectedCategory && vehicles.length === 0 ? (
            <div className="flex items-center justify-center h-64">
              <p className="text-2xl font-bold text-center">Select a category to browse vehicles</p>
            </div>
          ) : vehicles.length === 0 ? (
            <div className="flex items-center justify-center h-64">
              <p className="text-2xl font-bold text-center">No vehicles found in this category</p>
            </div>
          ) : (
            <>
              <p className="text-gray-500 mt-5 mb-2 text-right">{pagination.viewingRange}</p>
                ...
                {vehicles.map((vehicle) => (
                  <div
                    ...
                    className={`bg-white border-2 shadow-md px-2 pb-4 pt-2 rounded-lg overflow-hidden flex flex-col ${
                      favorites.some((fav) => fav.id === vehicle.id) ? "border-red-500" : ""
                    }`}
                  >
                    <div className="flex items-start justify-between w-full bg-gray-100">
                      <div className="flex-1 min-w-0 max-w-2/3">
                        <h3 className="text-lg font-bold sm:truncate sm:whitespace-nowrap break-words">
                          {vehicle.name}
                        </h3>
                    ...
                    <div className="flex justify-between items-center space-x-4 mt-2">
                      <button 
                        className="flex-1 bg-secondary px-4 py-2 border-2 border-secondary rounded-xl mt-2 text-white tracking-wide transform hover:scale-105 hover:shadow-lg transition-transform duration-200"
                        onClick={() => {
                          setModal2Open(true);
                          setSelectedVehicle2(vehicle);
                        }}
...
//   // Get manufacturers filtered by selected category
//   const filteredManufacturers = selectedCategory 
//     ? manufacturers.filter(m => m.categoryId === selectedCategory)
//     : manufacturers;
...
//           {/* Selected Category */}
//           {selectedCategory && (
//             <div className="flex items-center bg-white px-3 py-2 rounded-md shadow-sm border">
...
//                   <div 
//                     key={manufacturerId}
//                     className="flex items-center bg-white px-3 py-1 rounded-md shadow-sm border"
//                   >
//                     <span>{manufacturer.title}</span>
//                     <button 
//                       onClick={() => handleManufacturerChange(manufacturerId)}
//                       className="ml-2 text-gray-500 hover:text-red-500"
//                     >
//                       ×
//                     </button>
...
//         {/* Manufacturer Dropdown (only shown when category is selected) */}
//         {selectedCategory && (
...
//             >
//               {selectedManufacturers.length > 0 ? 'Add More Manufacturers' : 'Select Manufacturers'}
//             </button>
...
//                     manufacturers.map(manufacturer => (
//                       <div key={manufacturer.id} className="flex items-center p-2 hover:bg-gray-100">
//                         <input
//                           type="checkbox"
//                           id={`manufacturer-${manufacturer.id}`}
//                           checked={selectedManufacturers.includes(manufacturer.id)}
...
//                     ))
//                   ) : (
//                     <div className="p-2 text-gray-500">No manufacturers available for this category</div>
//                   )}
//                 </div>
//               </div>
//             )}
